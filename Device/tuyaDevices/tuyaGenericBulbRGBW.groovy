...
def parse(String description, byte[] decryptKey=state.realLocalKey) {
	...
	if (cmd != 4 && (status != null && status != "")) {
	...
	} else if (cmd == 40) { //TODO: Remove this as the new parser does the job
		// Generate last step
		...
		if(logEnable) log.debug sessKeyHEXString
